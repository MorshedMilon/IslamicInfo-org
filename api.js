...
(function (root) {
  ...
  /* ─── API base — Cloudflare Worker proxy (roadmap Step 4) ──────
     Replace with your own *.workers.dev URL after first deploy,
     or 'https://api.islamicinfo.org' once the custom domain is set.
     Must NOT end with a slash. ─────────────────────────────────── */
  const API_BASE = 'https://islamicinfo-api.YOUR-SUBDOMAIN.workers.dev';
