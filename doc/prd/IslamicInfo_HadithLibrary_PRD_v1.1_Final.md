...
sidebar collapses to a bottom sheet.
  ...
  **\#**   **Zone /      **HTML marker**        **Description**
  ...
  3a       ↳ Sidebar     \<aside                HADITH COLLECTIONS (9 rows) ·
...
**2.3 Hadith Collections Reference**
  ...
  ----------------------------------------------------------------------------------------------
  **Collection**   **Arabic   **Compiler**   **Hadiths**   **Books**   **Grade**   **Motif
                   Name**                                                          (mockup)**
  ---------------- ---------- -------------- ------------- ----------- ----------- -------------
  Sahih al-Bukhari صحيح       Imam           7,563         97          Sahih ---   📜 (featured,
                   البخاري    al-Bukhari ·                             Highest     \"✦ Most
                              810--870 CE                              Standard    Authentic\"
                                                                                   seal)

  Sahih Muslim     صحيح مسلم  Imam Muslim    5,362         56          Sahih       🔬
                              ibn al-Hajjaj                                        
                              · 815--875 CE                                        

  Sunan Abu Dawud  سنن أبي    Imam Abu Dawud 5,274         43          Mixed       ⚖️
                   داود       Sulayman ·                               Grades      
                              817--889 CE                                          

  Jami\'           جامع       Imam Muhammad  3,956         49          Mixed       📚
  at-Tirmidhi      الترمذي    at-Tirmidhi ·                            Grades      
                              824--892 CE                                          

  Sunan an-Nasa\'i سنن        Imam Ahmad     5,748         ---         Mixed       SVG motif
                   النسائي    an-Nasa\'i ·                             Grades      (Stage 3)
                              829--915 CE                                          

  Sunan Ibn Majah  سنن ابن    Ibn Majah      4,341         ---         Mixed       SVG motif
                   ماجه       al-Qazwini ·                             Grades      (Stage 3)
                              824--887 CE                                          

  Musnad Ahmad     مسند أحمد  Imam Ahmad ibn 27,647        ---         Mixed       SVG motif
                              Hanbal ·                                 Grades      (Stage 3)
                              780--855 CE                                          

  Riyad            رياض       Imam an-Nawawi 1,896         18          Sahih /     SVG
  as-Saliheen      الصالحين   · 1233--1277                             Hasan       heart+check
                              CE                                                   (in mockup)

  40 Hadith Nawawi الأربعون   Imam an-Nawawi 42            1           Sahih /     ✨
                   النووية    · 1233--1277                             Hasan       
                              CE                                                   
  ----------------------------------------------------------------------------------------------
...
- Sidebar lists all 9 collections with name + hadith count badge
...
- Collections grid renders all 9 collection cards. Each card: card-motif
...
- Stats strip (.stats-strip) renders 4 metrics verbatim from blueprint:
  61K+ Total Hadiths · 9 Major Collections · 12+ Languages · 100%
  Source-Verified
...
- Each of the 9 collection cards gains a custom illustrated motif SVG
...
- SVG files committed to
  /packages/ui/src/illustrations/hadith/{collection-slug}.svg (9 total)
...
- EYEBROW BADGE: \"✦ 9 Collections · 61,000+ Hadiths · Fully
  Source-Verified\"
...
Full-width .layout flex container (direction: row). Two panes:
  ...
  **Pane**     **Width**         **Contents**                     **Collapse
                                                                  behaviour**
  ------------ ----------------- -------------------------------- ---------------
  Sidebar      240px             HADITH COLLECTIONS (9            Collapses to
...
**5.1 Stage-by-Stage Feature Classification**
  ...
  **Feature**                  **Stage**   **Priority**   **Gap Status    **User
  ...
  Collections grid (9 cards,   Stage 1     P0             Present in      All
...
**6.1 Frontend Stack**
  ...
  **API ---        Sunnah.com API (primary) + self-hosted JSON
  Hadith**         (fallback + Meili search index)
  ...
  **Cache**        Redis --- 24h hadith text, 7d narrator data, 1h daily
                   hadith rotation
  ---------------- -----------------------------------------------------
...
**6.4 API Integration Map**
  ...
  **API / Source**           **Endpoint / Pattern**                              **Purpose**      **Cache
                                                                                                  TTL**
  -------------------------- --------------------------------------------------- ---------------- ---------
  Sunnah.com API             /v1/hadiths/search?q={query}&lang=en&limit=20       Hadith full-text 1h
                                                                                 search           

  Sunnah.com API             /v1/hadiths/{hadithId}?lang=en                      Single hadith    24h
                                                                                 text +           
                                                                                 translation +    
                                                                                 grade            

  Sunnah.com API             /v1/collections/{collection}/books                  Books list for   7d
                                                                                 Tier 2           

  Sunnah.com API             /v1/collections/{collection}/books/{book}/hadiths   Hadith list for  24h
                                                                                 Tier 3a          

  Sunnah.com API             /v1/hadiths/{hadithId}/similar                      Related hadiths  7d
                                                                                 (Stage 3)        
...
3.  Wire sidebar: all 9 collections with count badges, classical
    scholars, reading path rows (static for now), Verify + Ask CTAs

4.  Wire collections grid: live data for all 9 collections, filter tabs
...
35. Author and commit 9 collection illustrated motifs (SVG, 64×64,
    gold-500 accent)
...
55. Deploy; configure CDN + Redis; set up Sentry monitoring + uptime
    alerts
...
criteria are satisfied.
  ...
  **\#**   **Definition of Done Criterion**            **Verified By**
  ...
  8        Every hadith card shows a grade badge with  Product + QA
           a named grader --- verified across all 9    
           collections                                 
