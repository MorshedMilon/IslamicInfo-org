...
- **Client:** `src/js/quranly-ai.js` (window.QuranlyAI) consumes this SSE stream — self-mounting floating button + lazy Shadow-DOM panel; per-page integration in `doc/quranly-ai-integration.md`.
