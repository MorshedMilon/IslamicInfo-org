...
test('dua corpus: >=250 sourced duas, Hisn al-Muslim attribution, no empty records', (t) => {
  ...
  // meta.source was renamed to meta.compilation when the corpus moved to schema 2;
  // this assertion had been silently red ever since. Accept either spelling.
  assert.ok(/Hisn al-Muslim/i.test(d.meta.compilation || d.meta.source || ''), 'source attribution');
